...
import { IMAGE_RENDERING_CONFIG, ImageRenderingService } from 'services/image-rendering';
import { SessionService } from 'services/session';
import { ANALYTICS_CONFIG, ANALYTICS_SERVICE } from './analytics';
import { ENDANGERED_LANGUAGE_CONFIG, EndangeredLanguageService } from './endangered-language';
import { FEEDBACK_CONFIG, FEEDBACK_SERVICE } from './feedback';
import { IMAGE_RECOGNITION_CONFIG, IMAGE_RECOGNITION_SERVICE } from './image-recognition';
...
@NgModule({
  ...
  providers: [
    ...
    { provide: SENTENCE_CONFIG, useValue: environment.services.sentence.config },
